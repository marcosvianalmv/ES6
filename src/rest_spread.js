...
const timesDeFutrbolDeSp = ['santos', 'palmeiras', 'bragantino', 'sao paulo'];
const timesDeFutebolDoRio = ['vasco', 'botafogo', 'flamengo', 'fluminense'];

//const timesDeFutebol = timesDeFutrbolDeSp.concat(timesDeFutebolDoRio);

const timesDeFutebol = [...timesDeFutrbolDeSp, ...timesDeFutebolDoRio];
